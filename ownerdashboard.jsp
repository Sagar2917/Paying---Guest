...
<head>
    ...
    background-image: linear-gradient(180deg,#0f0e0f 10%,#3d303f 100%);
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="ownerdashboard.jsp">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="listpg.jsp" 
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
 <!-- owner profile -->                               <span class="mr-2 d-none d-lg-inline text-gray-600 small"><%= own.getName() %></span>
